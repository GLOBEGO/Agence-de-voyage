...
<body>
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          ...
          <img src="images/paris2.jpg" style="width:100%">
          
        </div>
        
        <div class="mySlides fade">
          <div class="numbertext">3 / 3</div>
          <img src="images/paris3.jpg" style="width:100%">
        ...
        <h1>Paris</h1>
        <p>Paris est à la hauteur de son battage médiatique : une ville avec une cuisine et une culture incroyables,<span id="dots">...</span><span id="more">ainsi que des vues imprenables partout où vous tournez. Avec 18 arrondissements, c’est beaucoup à voir en un seul voyage, mais chaque quartier a sa propre personnalité. Vous ne pouvez pas manquer l’emblématique 7ème, où l’art et l’histoire se rencontrent - il y a la tour Eiffel, bien sûr, mais l’impressionnant musée du quai Branly est à quelques pas. Il abrite une étonnante collection d’art indigène. Ou, hit up Montmartre (le 18ème), avec ses boutiques bohèmes et brasseries confortables. C’est un arrêt incontournable sur le chemin en haut ou en bas du Sacré-Cœur. Alors que les Français ont pratiquement inventé la gastronomie, ne ratez pas la street food : Paris a des kebabs et des falafels de classe mondiale. Mais peu importe où vous vous trouvez, assurez-vous de vous rendre dans un café sur le trottoir, de siroter un verre de vin et de regarder les gens – c’est le moyen de goûter à la vraie culture parisienne.
        </span></p>
          ...
          <ul class="price">
            ...
            <li class="grey"> <label for="firstSelect">Choisissez une option:</label>
              <select name="firstSelect" id="firstSelect" onchange="updateOptions(this.value)">
                <option value="">--Sélectionnez une option--</option>
                <option value="a">Fitzgerald Hotel</option>
                <option value="b">Ramada Hollywood</option>
                <option value="c">Hilton Hotels</option>
              </select></li>
        ...
        <ul class="price">
          ...
          <li class="grey"> <label for="label2">Choisissez une option:</label>
            <select name="label2" id="label2" >
              <option value="">--Sélectionnez une option--</option>
              <option value="d">The Maxwell Hotel</option>
              <option value="e">La Serene Hotel</option>
              <option value="f">Four Seasons</option>
            </select></li>
        ...
        <ul class="price">
          ...
          <li class="grey"> <label for="label3">Choisissez une option:</label>
            <select name="label3" id="label3" >
              <option value="">--Sélectionnez une option--</option>
              <option value="h">Dragonheart Inn</option>
              <option value="i">Loftus Cheek</option>
              <option value="g">Dionysus Dreams</option>
            </select></li>
...
document.getElementById('label2').addEventListener('change', function() {
    ...
    if (value === 'd') labelY.innerHTML = '<option value="355">355</option>';
    else if (value === 'e') labelY.innerHTML = '<option value="255">255</option>';
    else if (value === 'f') labelY.innerHTML = '<option value="300">300</option>';
  });
document.getElementById('label3').addEventListener('change', function() {
    var value = this.value;
    var labelZ = document.getElementById('labelZ');
    if (value === 'g') labelZ.innerHTML = '<option value="850">850</option>';
    else if (value === 'h') labelZ.innerHTML = '<option value="770">770</option>';
    else if (value === 'i') labelZ.innerHTML = '<option value="999">999</option>';
  });
