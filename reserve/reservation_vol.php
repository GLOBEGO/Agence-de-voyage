...
$email = $_SESSION['email'];
$date = $_POST['date'];
$compagnie = $_POST['label5'];
$num_passengers = $_POST['multiplier2'];
$prix = $_POST['pls2'];

// Insert the data into the reservation table
$sql = "INSERT INTO reservation_vol (email, date, compagnie,num_passengers, prix, classe,destination) VALUES (?, ?, ?, ?, ?, 'economique','$dest')";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssid", $email, $date, $compagnie, $num_passengers, $prix);
$result = $stmt->execute();
